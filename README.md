...
```javascript
import { add, assert, div, exponentf, float32ToInt32, float32ToUint32, fromBinaryStringf, fromWordf, identity, mul, normalizef, signbitf, significandf, sub, toBinaryStringf, toWordf, ulpdiff } from 'https://cdn.jsdelivr.net/gh/stdlib-js/number-float32-base@v0.3.0-deno/mod.js';
```
